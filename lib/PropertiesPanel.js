...
PropertiesPanel.prototype.getCmdHandlers = function() {
  return {
    ...
    'properties-panel.complex-update': require('./cmd/ComplexUpdateHandler')
  };
};
  ...
  forEach(controlNodes, function(controlNode) {
    ...
    if (error) {
      ...
      if (!errorMessageNode) {
        ...
        // insert errorMessageNode after controlNode button
        controlNode.parentNode.appendChild(errorMessageNode);
      }
